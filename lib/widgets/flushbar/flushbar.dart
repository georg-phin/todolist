...
import 'package:todolist/storage/colors.dart';
...
class Flushbar<T extends Object> extends StatefulWidget {
  ...
  route.FlushbarRoute<dynamic> _flushbarRoute;
...
class _FlushbarState<K extends Object> extends State<Flushbar>
  ...
  Widget _getFlushbar() {
    Widget flushbar = widget.userInputForm != null
  ...
  List<Widget> _getAppropriateRowLayout() {
    ...
    return widget.icon == null && widget.mainButton == null
        ? [
        ...
        : widget.icon != null && widget.mainButton == null
            ? <Widget>[
                _buildLeftBarIndicator(),
                ConstrainedBox(
                  constraints:
...
void flushi(texti,context,millseconds,)=>
 Flushbar(
      message: texti ?? '',
      animationDuration: const Duration(milliseconds: 600),
      duration: Duration(milliseconds: millseconds),
      backgroundColor: navigationBarC,
